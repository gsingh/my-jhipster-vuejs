<template>
    <div>
        ...
        <div class="table-responsive" v-if="productions">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th v-on:click="changeOrder('prodDate')"><span>Prod Date</span> <font-awesome-icon icon="sort"></font-awesome-icon></th>
                    ...
                    <th v-on:click="changeOrder('prodTonnage')"><span>Prod Tonnage</span> <font-awesome-icon icon="sort"></font-awesome-icon></th>
                    <th v-on:click="changeOrder('manager.id')"><span>Manager</span> <font-awesome-icon icon="sort"></font-awesome-icon></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
                <tr v-for="production of orderBy(productions, propOrder, reverse === true ? 1 : -1)"
                    :key="production.id">
                    <td>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="platemillvuejsApp.production.delete.question">Confirm delete operation</span></span>
