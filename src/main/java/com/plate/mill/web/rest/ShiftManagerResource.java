...
public class ShiftManagerResource {
    ...
    public ShiftManagerResource(ShiftManagerService shiftManagerService) {
    ...
    public ResponseEntity<ShiftManager> createShiftManager(@Valid @RequestBody ShiftManager shiftManager) throws URISyntaxException {
        ...
        ShiftManager result = shiftManagerService.save(shiftManager);
    ...
    public List<ShiftManager> getAllShiftManagers() {
        ...
        return shiftManagerService.findAll();
    }
    ...
    public ResponseEntity<ShiftManager> getShiftManager(@PathVariable Long id) {
        ...
        Optional<ShiftManager> shiftManager = shiftManagerService.findOne(id);
    ...
    public ResponseEntity<Void> deleteShiftManager(@PathVariable Long id) {
        ...
        shiftManagerService.delete(id);
        return ResponseEntity.noContent().headers(HeaderUtil.createEntityDeletionAlert(applicationName, false, ENTITY_NAME, id.toString())).build();
    }

    /**
     * {@code SEARCH  /_search/shift-managers?query=:query} : search for the shiftManager corresponding
     * to the query.
     *
     * @param query the query of the shiftManager search.
     * @return the result of the search.
     */
    @GetMapping("/_search/shift-managers")
    public List<ShiftManager> searchShiftManagers(@RequestParam String query) {
        log.debug("REST request to search ShiftManagers for query {}", query);
        return shiftManagerService.search(query);
    }
