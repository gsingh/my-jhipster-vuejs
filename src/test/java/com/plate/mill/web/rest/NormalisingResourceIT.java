...
public class NormalisingResourceIT {
    ...
    @Autowired
    private NormalisingService normalisingService;
    ...
    public void setup() {
        ...
        final NormalisingResource normalisingResource = new NormalisingResource(normalisingService);
    ...
    public void updateNormalising() throws Exception {
        // Initialize the database
        normalisingService.save(normalising);
        // As the test used the service layer, reset the Elasticsearch mock repository
        reset(mockNormalisingSearchRepository);
    ...
    public void searchNormalising() throws Exception {
        // Initialize the database
        normalisingService.save(normalising);
        when(mockNormalisingSearchRepository.search(queryStringQuery("id:" + normalising.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(normalising), PageRequest.of(0, 1), 1));
